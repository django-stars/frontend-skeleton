/**
 * extractCss webpack block.
 *
 * @see https://webpack.js.org/plugins/mini-css-extract-plugin/
 */

// ====================================================================
// NOTE: this is a copy of extract-text webpack block
// extract-text-webpack-plugin is replaced to mini-css-extract-plugin
// ===================================================================
 ...
 * @return {Function}
 */
export default function extractCss(outputFilePattern = 'css/[name].[contenthash:8].css') {
  const plugin = new MiniCssExtractPlugin({ filename: outputFilePattern })
